/**
 * Created by author on 2017/4/22.
 */
...
class BreadcrumbCustom extends React.Component {
    ...
    render() {
        ...
        return (
            <span>
                <Breadcrumb style={{padding:'27px 28px 14px 28px'}}>
                    <Breadcrumb.Item><Link to={'/app/business/basicInfor'}>企业管理后台系统</Link></Breadcrumb.Item>
                        {first}
                        {second}
                </Breadcrumb>
